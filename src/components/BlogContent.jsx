...
const BlogContent = ({blogs}) => {
    ...
    console.log(blog); // Log the selected blog
        ...
        <div className='max-w-[1240px] mx-auto'>
            ...
            md:gap-x-8 sm:gap-y-8 ss:gap-y-8 px-4 sm:pt-20 md:mt-0 ss:pt-20 text-black'>
                ...
                <div className='col-span-2 '>
                    <img className='h-56 w-full object-cover' src={`http://localhost:1337${blog.coverImg[0].url}`} />
                    <h1 className='font-bold text-2xl my-1 pt-5'>{blog.blogTitle}</h1>
                    <div className='pt-5'>
                        <ReactMarkdown className='line-break'>{blog.blogContent[0].children[0].text}</ReactMarkdown>
                    </div>
                ...
                <div className='items-center w-full bg-white rounded-xl drop-shadow-md py-5 max-h-[250px]'>
                    <div>
                        <img className='p-2 w-32 h-32 rounded-full mx-auto object-cover' src={`http://localhost:1337${blog.authorImg.url}`} />
                        <h1 className='font-bold text-2xl text-center text-gray-900 pt-3'>{blog.authorName}</h1>
                        <p className='text-center text-gray-900 font-medium'>{blog.blogDesc}</p>
                    </div>
